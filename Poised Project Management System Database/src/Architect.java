...
public class Architect {
	...
	public void addArchitect() {
		try {
			...
			printAllFromTableArchitect(statement);
	 ...
	 * @throws SQLException
	 */
	public void printAllFromTableArchitect(Statement statement) throws SQLException {
		ResultSet results = statement.executeQuery("SELECT architectID, name, telnumber, address FROM architect");
		while (results.next()) {
			System.out.println(
